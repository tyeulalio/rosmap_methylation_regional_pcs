...
# remove individuals from the metadata if they were outliers
...
# -- check correlations between PCs and clinical traits
...
# plot the p-values as tile plot
head(pvals_long)
pvals_long %>%
    filter(bf_pval < 0.1)
