...
process_run <- function(run){
    ...
    process_chrom <- function(chrom){
        ...
        # summary file
        datafile <- paste0("/path/to/new_rosmap/output/07_ptwas/07_ptwas_scan/",
                           gwas_type, "/",
                           proportion_type, "/",
    ...
    if (check_missing){
        ...
        datadir <- paste0("/path/to/new_rosmap/output/07_ptwas/01_ptwas_weights/with_proportions/", 
    ...
    # save to output file
    savedir <- paste0("/path/to/new_rosmap/output/07_ptwas/07_ptwas_scan/", 
                      gwas_type, "/",
                      proportion_type, "/",
                      runname, "/") 
