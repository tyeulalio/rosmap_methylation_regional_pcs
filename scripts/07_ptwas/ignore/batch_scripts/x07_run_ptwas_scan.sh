...
PTWAS_WEIGHT_FILE="/home/eulalio/deconvolution/new_rosmap/output/07_ptwas/03_gambit_db/${PROPORTION_TYPE}/${RUNNAME}/chrom${CHROM}_all_gene.ptwas_weights.gambit.vcf.gz"
