...
#REGION_TYPE=${REGION_TYPES[2]} # full_gene, promoters, exons
...
#declare -a cell_types=( "bulk" "astro" "endo" "neuron" "oligo_opc")
#declare -a cell_types=( "endo" "neuron" "oligo_opc")
...
OUTDIR="${HOME}/deconvolution/new_rosmap/output/07_ptwas/01_ptwas_weights"
mkdir -p $OUTDIR
OUTDIR="${OUTDIR}/${PROPORTION_TYPE}"
. ./helper_scripts/make_output_directory.sh $OUTDIR $RUNNAME

# input directories
SBAMSDIR="${HOME}/deconvolution/new_rosmap/output/06_fine_mapping_colocalization/03_qtl_prep/03_dapg_input/${PROPORTION_TYPE}/${RUNNAME}/sbams"
DAPDIR="${HOME}/deconvolution/new_rosmap/output/06_fine_mapping_colocalization/03_qtl_prep/04_dapg/${PROPORTION_TYPE}/${RUNNAME}"
