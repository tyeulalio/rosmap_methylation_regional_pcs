...
do
    ...
    LD_VCF="/path/to/new_rosmap/output/07_ptwas/05_lifted_ld_panel/${GWAS_TYPE}/G1K_EUR_3V5_hg38/chr${CHROM}.vcf.gz"

    # swapped file containing alelles to update
    SWAPFILE="/path/to/new_rosmap/output/07_ptwas/05_lifted_ld_panel/${GWAS_TYPE}/plink_formatted_swapped_chr${CHROM}.txt"

    # output file
    OUTDIR="/path/to/new_rosmap/output/07_ptwas/06_swapped_ld_panels/${GWAS_TYPE}"
    mkdir -p $OUTDIR
